<template>
    <div v-loading="loading">
     <div class="sign-msg-list">
      <div class="sign-msg-container" v-for="(item,index) in signContinueDataList" :key="index">
          ...
          <div class="sign-detail-container">
            ...
            <div class="sign-detail-right">
                <el-tag type="success"  >连续签到{{ item.continueTotal}}天</el-tag>
            </div>
          </div>
      </div>
...
export default {
    ...
    created(){
        this.getSignContinueList()
    },
    methods:{
        getSignContinueList(){
            this.loading=true
            signApi.getContinueSignDay(this.page).then(res =>{
                this.page=res.data
                this.signContinueDataList=this.page.data
                this.page.data=null
                this.loading=false
            })
       },
